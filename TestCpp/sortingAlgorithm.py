...
class sortingAlgorithm(object):
    def __repr__(self):
        ...
        result = str("\t[ Object Oritented Sorting Algorithm ]\n"
                    f"Origin array:     {sort_me}\n"
                    ...
                    f"Quick Sort:       {self.quick_sort(sort_me)}\tBig-O: O(Nlog(N))\n")
        return result
    ...
    def merge_sort(self, nums):
        def merge(left_list, right_list):
            ...
            for _ in range(0,left_list_length + right_list_length):
